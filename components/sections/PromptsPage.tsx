...
export const PromptsPage = () => {
  ...
  const tabs = [
    { id: 'foundation', label: 'Brand Profile', icon: Info },
    { id: 'templates', label: 'Templates', icon: Layers },
    { id: 'builder', label: 'Prompt Builder', icon: Wand2 },
  ...
  return (
    <div>
      <PageHero icon={Wand2} kicker="AI Prompt Generator" title="Prompts for AI Tools" titleHighlight="AI" description="Write prompts that make AI tools produce MediaBubble-consistent output. Powered by your brand colors, fonts, voice, and layout rules." />

      <div className="px-6 lg:px-10 py-8 lg:py-12 max-w-[1400px] mx-auto space-y-8">
      {/* Generated Prompt Display */}
      {generatedPrompt && (
        <div className="bg-[#FAFAFA] border border-[#E8E8E8] rounded-xl p-6 animate-fade-in-up">
          <div className="flex items-start justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="text-[14px] font-semibold text-[#333333]">Your Prompt</h3>
                <p className="text-[11px] text-[#9E9E9E]">Copy and paste into ChatGPT, Midjourney, DALL-E, or any AI tool</p>
              </div>
            </div>
            <button
          ...
          <div className="bg-[#FFFFFF] border border-[#E8E8E8] rounded-lg p-4 font-mono text-[12px] text-[#333333] whitespace-pre-wrap">
            {generatedPrompt}
          </div>
        </div>
      )}
      ...
      {/* Tabs */}
      <div className="flex items-center gap-1 bg-[#FFFFFF] border border-[#E8E8E8] rounded-xl p-1">
        {tabs.map((tab) => {
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg text-[13px] font-medium transition-all duration-200 ${
                isActive
                  ...
                  : 'text-[#9E9E9E] hover:text-[#333333] hover:bg-[#F5F5F5]'
              }`}
            >
