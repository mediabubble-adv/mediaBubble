...
export function VoiceTonePage() {
  ...
  const registers = [
    ...
    },
    {
      ...
      phrases: [
        ...
        { text: 'Schedule a Free Consultation', ok: true },
  ...
  const ctaLevels = [
    ...
    },
    {
      ...
      desc: 'Use \u201cExplore [Service Name]\u201d for service pages, \u201cView Our Work\u201d for portfolio. Avoid \u201cLearn More\u201d as a standalone CTA.',
    },
    {
      level: 'Tertiary CTA',
      color: '#9E9E9E',
  ...
  const prohibited = [
    ...
    { word: 'Contact us today', why: 'Weak CTA \u2014 replace with \u201cSchedule a Free Consultation\u201d' },
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-[#0D0F12] text-white">
                <th className="text-left px-5 py-3 text-[11px] font-semibold uppercase tracking-[0.08em]">{t('Content Type')}</th>
                <th className="text-left px-5 py-3 text-[11px] font-semibold uppercase tracking-[0.08em]">{t('Register')}</th>
                <th className="text-left px-5 py-3 text-[11px] font-semibold uppercase tracking-[0.08em]">{t('Tone Adjustment')}</th>
              </tr>
            </thead>
