...
export const brand = {
  ...
  description: 'MediaBubble is a marketing and advertising agency based in Hurghada, Egypt. Since 2015, a team of 22+ strategists, designers, and developers has helped brands grow through SEO, branding, web development, and content — measuring outcomes, not outputs.',
  services: [
...
export const colorFamilies = [
  {
    name: 'Brand Blue',
    role: 'Primary color — navigation, interactive elements, links',
    hex: '#2196F3',
  ...
  {
    name: 'Dark Blue',
    role: 'Depth — headings, dark surfaces, sidebar backgrounds',
    hex: '#1565C0',
  ...
  {
    name: 'Brand Yellow',
    role: 'Accent — CTAs, highlights, active indicators',
    hex: '#FFC107',
