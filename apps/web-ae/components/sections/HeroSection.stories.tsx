...
const HERO_DESCRIPTION =
  'From strategy through execution, we help UAE businesses grow with campaigns you can measure. Based in Dubai, serving the Emirates and the wider Gulf since 2015.'
...
export const ImageRight: Story = {
  args: {
    ...
    subtitle: 'Proven Strategy + Expert Execution',
    description:
      'From strategy through execution, we help UAE businesses grow with campaigns you can measure.',
...
export const WithStats: Story = {
  args: {
    layout: 'image-right',
    title: "Dubai's Trusted Marketing Partner",
    subtitle: 'Results You Can Measure',
    description:
      'MediaBubble is a marketing agency serving the UAE. Since 2015, we have helped 200+ brands grow through SEO, branding, web, and paid ads.',
