...
const FEATURES: FeatureItem[] = [
  ...
  },
  {
    ...
    titleFallback: 'Regional expertise, global standards',
    descKey: 'features.trust.description',
    descFallback: 'UAE market knowledge with production quality that stands up to international brands.',
  },
]
    ...
    <section dir={dir} aria-labelledby="features-heading" className="py-12 sm:py-20 lg:py-28 bg-brand-surface">
      <Container>
        <SectionHeader
          ...
          intro={t(
            'features.intro',
            'We combine strategy, creative, and performance so hospitality, retail, and tourism brands win more customers across the UAE.',
          )}
          align="left"
