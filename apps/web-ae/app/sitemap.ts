...
import { INSIGHTS_POSTS } from '@/lib/data/insights-posts'
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const insightsRoutes: MetadataRoute.Sitemap = INSIGHTS_POSTS.map((post) => ({
  ...
  return [...staticRoutes, ...serviceRoutes, ...caseStudyRoutes, ...insightsRoutes]
}
