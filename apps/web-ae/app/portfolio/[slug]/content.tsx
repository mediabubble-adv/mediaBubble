...
import { CaseStudyHero } from '@/components/features/blog/CaseStudyHero'
import { PortfolioGallery } from '@/components/features/portfolio/PortfolioGallery'
import { PortfolioBeforeAfter } from '@/components/features/portfolio/PortfolioBeforeAfter'
import { CaseStudyDetails } from '@/components/features/portfolio/CaseStudyDetails'
import { CaseStudyCta } from '@/components/features/portfolio/CaseStudyCta'
...
export function CaseStudyContent({ cs }: Props) {
  return (
    <MainLayout>
        ...
        {cs.beforeAfter && <PortfolioBeforeAfter pair={cs.beforeAfter} accent={cs.accent} />}
        <PortfolioGallery cs={cs} />
