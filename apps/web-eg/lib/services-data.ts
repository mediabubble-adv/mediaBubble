...
export const SERVICES: Record<string, ServiceData> = {
  seo: {
    ...
    process: [
      ...
      { step: 2, title: 'Keyword Research', description: 'Map high-intent keywords your customers actually use: including local Hurghada terms competitors are missing.' },
  ...
  ppc: {
    slug: 'ppc',
    meta: {
      title: 'Paid Advertising (PPC) | MediaBubble Hurghada',
      description:
        'Google and Meta ad campaigns for Hurghada businesses. Average 4.2× ROAS within 90 days. Transparent reporting, no surprises. Get a free audit today.',
    },
    hero: {
    ...
    caseStudy: {
      ...
      description:
        'Aqua Sports Egypt was spending 8,000 EGP/month on Meta Ads with minimal bookings. After restructuring campaigns, building retargeting audiences, and refreshing creative, they hit 4.8× ROAS within 60 days.',
      company: 'Aqua Sports Egypt',
      href: '/portfolio',
      quote:
      ...
      author: 'Sara Khalil',
      authorTitle: 'Marketing Director, Aqua Sports Egypt',
    },
    faqs: [
      {
      ...
      },
      {
        ...
        answer: 'We recommend a minimum of 3,000–5,000 EGP/month in ad spend. Below that, data accumulates too slowly to optimise effectively and results become inconsistent.',
      },
      {
  ...
  social: {
    slug: 'social',
    meta: {
      title: 'Social Media Marketing | MediaBubble Hurghada',
      description:
        'Social media management for tourism and hospitality brands in Egypt. Content calendars, community management, and paid social. Talk to our team today.',
    },
    hero: {
  ...
  branding: {
    slug: 'branding',
    meta: {
      title: 'Branding & Design | MediaBubble Hurghada',
      description:
        'Brand strategy, logo design, and visual identity for Hurghada businesses. 150+ brands created since 2015. Build an identity that commands premium pricing.',
    },
    hero: {
  ...
  web: {
    slug: 'web',
    meta: {
      title: 'Web Development | MediaBubble Hurghada',
      description:
        'Custom websites for Hurghada businesses. Sub-2s load times, 95+ Lighthouse scores, conversion-optimised design. 200+ sites delivered since 2015.',
    },
    hero: {
    ...
    caseStudy: {
      ...
      description:
        'Hurghada Rentals\' old site took 8 seconds to load on mobile. We rebuilt it in Next.js, restructured the property listing UX, and added live booking widgets. Enquiries nearly tripled in the first month.',
      company: 'Hurghada Rentals',
      href: '/portfolio',
      quote:
      ...
      authorTitle: 'Founder, Hurghada Rentals',
    },
    faqs: [
      {
