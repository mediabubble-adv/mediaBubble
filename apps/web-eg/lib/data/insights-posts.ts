...
export const INSIGHTS_POSTS: InsightPost[] = [
  {
    ...
    accent:   '#2196F3',
    featured: true,
    image:    '/assets/insights/seo-hurghada-tourism-editorial.webp',
    imageAlt: 'Egyptian SEO strategist reviewing tourism search planning materials in a Hurghada office overlooking the Red Sea',
    imageDescription: 'Editorial cover image for SEO strategies targeting Hurghada tourism businesses.',
    authorId: 'omar',
    intro:
    ...
    sections: [
      {
        ...
        body:    "The mistake most tourism businesses make is targeting high-volume keywords with no booking intent. 'Hurghada' gets 500k+ monthly searches but almost none of those people are ready to book. Instead, target layered intent: 'family-friendly hotels Hurghada' or 'best diving site near Hurghada' captures someone 48 to 72 hours from a decision.",
      },
      {
      ...
      },
      {
        ...
        body:    "Hurghada has three distinct booking seasons: winter sun (Oct–Feb), spring break (Mar–May), and summer family (Jun–Sep). Build a content calendar that anticipates demand by 8 to 12 weeks. A 'best Hurghada hotels for winter sun' guide published in August will have time to rank before the October surge.",
      },
    ],
  ...
  },
  {
    ...
    accent:   '#072A6B',
    featured: true,
    image:    '/assets/insights/google-ads-roas-red-sea-editorial.webp',
    imageAlt: 'Hotel commercial manager and MediaBubble strategist reviewing paid media and booking value reports in a Red Sea resort lounge',
    imageDescription: 'Editorial cover image for Google Ads ROAS guidance for Red Sea hospitality brands.',
    authorId: 'sara',
    intro:
  ...
  },
  {
    ...
    date:     'March 2025',
    accent:   '#1565C0',
    image:    '/assets/insights/social-media-egypt-2025-editorial.webp',
    imageAlt: 'Egyptian content creator filming vertical social content on a Hurghada terrace while a strategist reviews the shot plan',
    imageDescription: 'Editorial cover image for Egypt social media platform strategy in 2025.',
    authorId: 'sara',
    intro:
    ...
    sections: [
      {
        ...
        body:    "Facebook remains the highest-reach platform for audiences over 35 in Egypt. For real estate, healthcare, and financial services businesses targeting established professionals, Facebook still outperforms Instagram on cost per lead by 20 to 35%. The format that works: short video (under 60 seconds) with hard-cut subtitles and a specific, single offer.",
      },
      {
        heading: 'Instagram dominates tourism and hospitality',
        body:    "For hotels, resorts, restaurants, and tourism operators, Instagram is the primary discovery platform. The Explore algorithm rewards consistent posting (5 to 7 times per week), high-resolution imagery, and Reels with original audio. Carousel posts about 'what to do in Hurghada' consistently outperform promotional content by 3 to 4× on reach.",
      },
      {
        heading: 'TikTok: high risk, high reward',
        body:    "TikTok in Egypt has 23 million monthly active users and is growing fastest among the 18 to 30 demographic. For tourism businesses, a single organic video reaching 100k+ views is achievable with the right hook. The risk: it requires authentic, behind-the-scenes content that many businesses are not comfortable producing. Polished promotional content performs poorly.",
      },
      {
  ...
  },
  {
    ...
    date:     'February 2025',
    accent:   '#FFC107',
    image:    '/assets/insights/branding-small-business-egypt-editorial.webp',
    imageAlt: 'Egyptian brand designer reviewing Pantone swatches, logo concepts, and packaging mockups in a MediaBubble style studio',
    imageDescription: 'Editorial cover image for premium branding on a small business budget.',
    authorId: 'yasser',
    intro:
    ...
    sections: [
      ...
      },
      {
        ...
        body:    "Stock photos signal inauthenticity immediately. A single half-day shoot with a local photographer, producing 40 to 60 usable images, will transform your website and social media. For food businesses, retail, and hospitality this is non-negotiable. Budget EGP 2,000 to 5,000.",
      },
      {
  ...
  },
  {
    ...
    date:     'January 2025',
    accent:   '#2196F3',
    image:    '/assets/insights/website-conversion-rate-optimisation-editorial.webp',
    imageAlt: 'Web strategist and developer reviewing landing page prototype screens and UX notes in a coastal creative office',
    imageDescription: 'Editorial cover image for the 12-point website CRO audit checklist.',
    authorId: 'omar',
    intro:
  ...
  },
  {
    ...
    date:     'December 2024',
    accent:   '#072A6B',
    image:    '/assets/insights/content-marketing-roi-editorial.webp',
    imageAlt: 'Two strategists reviewing editorial performance reports and attribution materials in a Hurghada creative office',
    imageDescription: 'Editorial cover image for measuring content marketing ROI with attribution.',
    authorId: 'omar',
    intro:
  ...
  },
  {
    ...
    category: 'SEO',
    title:    'Google Business Profile for Hurghada: The Local SEO Checklist',
    excerpt:  'Your GBP listing is often the first impression for travellers. Here is how to optimise photos, categories, posts, and reviews for Hurghada searches.',
    readTime: '6 min read',
    date:     'June 2025',
    accent:   '#2196F3',
    image:    '/assets/insights/google-business-profile-local-seo-editorial.webp',
    imageAlt: 'Business owner and MediaBubble strategist capturing fresh storefront imagery and reviewing local listing assets outside a Hurghada business',
    imageDescription: 'Editorial cover image for Google Business Profile optimisation in Hurghada.',
    authorId: 'omar',
    intro:
      'When someone searches "diving centre Hurghada" or "restaurant near Marina", Google often shows the map pack before organic results. Your Google Business Profile (GBP) is the asset that wins those clicks — or loses them to a competitor with better photos and fresher reviews.',
    sections: [
      {
  ...
  },
  {
    ...
    excerpt:  'Abandoned browse, post-stay upsell, and seasonal campaigns — the three email flows that pay for themselves for Red Sea hospitality brands.',
    readTime: '7 min read',
    date:     'May 2025',
    accent:   '#1565C0',
    image:    '/assets/insights/email-marketing-tourism-editorial.webp',
    imageAlt: 'Marketer planning tourism email sequences on a laptop beside guest journey notes and hospitality campaign materials',
    imageDescription: 'Editorial cover image for tourism email marketing automation sequences.',
    authorId: 'sara',
    intro:
      'Social algorithms change every quarter. Your email list is the audience you own. For hotels and tour operators in Hurghada, three automated sequences consistently outperform one-off newsletters: welcome + offer, abandoned interest recovery, and post-stay re-engagement.',
    sections: [
      {
  ...
  {
    slug:     'whatsapp-marketing-egypt',
    category: 'Social Media',
    title:    'WhatsApp Marketing in Egypt: Compliance, Templates, and Conversion',
    excerpt:  'WhatsApp is the default channel for Egyptian consumers — but broadcast blasts kill deliverability. Here is how to use WhatsApp Business API properly.',
    readTime: '8 min read',
    date:     'April 2025',
    accent:   '#25D366',
    image:    '/assets/insights/whatsapp-marketing-egypt-editorial.webp',
    imageAlt: 'Egyptian booking specialist handling a phone enquiry at a premium hospitality support desk with messaging workflow materials nearby',
    imageDescription: 'Editorial cover image for WhatsApp Business marketing in Egypt.',
    authorId: 'sara',
    intro:
  ...
  },
  {
    ...
    date:     'March 2025',
    accent:   '#072A6B',
    image:    '/assets/insights/landing-page-anatomy-editorial.webp',
    imageAlt: 'Monitor and tabletop wireframes showing a high converting tourism landing page structure in a premium creative studio',
    imageDescription: 'Editorial cover image for tourism landing page structure and conversion design.',
    authorId: 'yasser',
    intro:
      'Sending paid traffic to your homepage is the most common waste we see in hospitality accounts. A campaign-specific landing page mirrors the ad promise, removes navigation noise, and gives Google Ads a clear conversion signal. Here is the block order we use for Red Sea clients.',
    sections: [
      {
      ...
      },
      {
        ...
        body:    'On mobile, pin a slim bar with phone and WhatsApp after the user scrolls past the hero. Most Hurghada bookings still start with a message or call — make that one tap away.',
      },
    ],
