...
export const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    accent: '#2196F3',
    bg: '#EBF5FB',
    heroImage: caseStudyAsset('coral-bay', 'hero', true),
    heroImageAlt: 'Coral Bay Resort premium beachfront pool and sea view, Hurghada',
    gallery: [
      { src: caseStudyAsset('coral-bay', 'gallery-1', true), alt: 'Resort exterior with palm trees and Red Sea coastline', caption: 'Brand positioning refresh across booking touchpoints' },
      { src: caseStudyAsset('coral-bay', 'gallery-2', true), alt: 'Guests relaxing by the resort pool', caption: 'Paid campaigns aligned to high-intent seasonal demand' },
      { src: caseStudyAsset('coral-bay', 'gallery-3', true), alt: 'Aerial view of beachfront resort property', caption: 'Direct booking landing page with OTA price-match messaging' },
    ],
    beforeAfter: {
      label: 'Booking funnel before and after our engagement',
      before: { src: caseStudyAsset('coral-bay', 'before', true), alt: 'Generic hotel room before repositioning and direct-booking focus' },
      after: { src: caseStudyAsset('coral-bay', 'after', true), alt: 'Premium resort experience after brand and conversion overhaul' },
    },
  ...
  },
  {
    ...
    accent: '#072A6B',
    bg: '#EEF2F9',
    heroImage: caseStudyAsset('red-sea-divers', 'hero', true),
    heroImageAlt: 'Scuba diver exploring coral reef in the Red Sea, Hurghada',
    gallery: [
      { src: caseStudyAsset('red-sea-divers', 'gallery-1', true), alt: 'Underwater diving scene with vibrant coral', caption: 'Long-form guide hub targeting informational diving queries' },
      { src: caseStudyAsset('red-sea-divers', 'gallery-2', true), alt: 'Rough sea surface before content-led visibility push', caption: 'Pre-engagement: minimal organic footprint' },
      { src: caseStudyAsset('red-sea-divers', 'gallery-3', true), alt: 'Dive boat on calm Red Sea waters', caption: 'Local SEO and review strategy for Hurghada map pack' },
    ],
    beforeAfter: {
      label: 'Organic visibility transformation',
      before: { src: caseStudyAsset('red-sea-divers', 'before', true), alt: 'Choppy Red Sea conditions symbolising weak search presence' },
      after: { src: caseStudyAsset('red-sea-divers', 'after', true), alt: 'Clear underwater visibility after SEO and content programme' },
    },
