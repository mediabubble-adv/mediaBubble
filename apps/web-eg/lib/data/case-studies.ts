...
export const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    accent: '#2196F3',
    bg: '#EBF5FB',
    heroImage: '/assets/case-studies/coral-bay/hero-v2.webp',
    heroImageAlt: 'Coral Bay Resort premium beachfront pool and sea view, Hurghada',
    gallery: [
      { src: '/assets/case-studies/coral-bay/gallery-1-v2.webp', alt: 'Resort exterior with palm trees and Red Sea coastline', caption: 'Brand positioning refresh across booking touchpoints' },
      { src: '/assets/case-studies/coral-bay/gallery-2-v2.webp', alt: 'Guests relaxing by the resort pool', caption: 'Paid campaigns aligned to high-intent seasonal demand' },
      { src: '/assets/case-studies/coral-bay/gallery-3-v2.webp', alt: 'Aerial view of beachfront resort property', caption: 'Direct booking landing page with OTA price-match messaging' },
    ],
    beforeAfter: {
      label: 'Booking funnel before and after our engagement',
      before: { src: '/assets/case-studies/coral-bay/before-v2.webp', alt: 'Generic hotel room before repositioning and direct-booking focus' },
      after: { src: '/assets/case-studies/coral-bay/after-v2.webp', alt: 'Premium resort experience after brand and conversion overhaul' },
    },
  ...
  },
  {
    ...
    accent: '#072A6B',
    bg: '#EEF2F9',
    heroImage: '/assets/case-studies/red-sea-divers/hero-v2.webp',
    heroImageAlt: 'Scuba diver exploring coral reef in the Red Sea, Hurghada',
    gallery: [
      { src: '/assets/case-studies/red-sea-divers/gallery-1-v2.webp', alt: 'Underwater diving scene with vibrant coral', caption: 'Long-form guide hub targeting informational diving queries' },
      { src: '/assets/case-studies/red-sea-divers/gallery-2-v2.webp', alt: 'Rough sea surface before content-led visibility push', caption: 'Pre-engagement: minimal organic footprint' },
      { src: '/assets/case-studies/red-sea-divers/gallery-3-v2.webp', alt: 'Dive boat on calm Red Sea waters', caption: 'Local SEO and review strategy for Hurghada map pack' },
    ],
    beforeAfter: {
      label: 'Organic visibility transformation',
      before: { src: '/assets/case-studies/red-sea-divers/before-v2.webp', alt: 'Choppy Red Sea conditions symbolising weak search presence' },
      after: { src: '/assets/case-studies/red-sea-divers/after-v2.webp', alt: 'Clear underwater visibility after SEO and content programme' },
    },
    client: 'Red Sea Divers',
    duration: '12 months',
  ...
  },
  {
    ...
    accent: '#1565C0',
    bg: '#E8EEF7',
    heroImage: caseStudyAsset('aqua-sports', 'hero', true),
    heroImageAlt: 'Watersports action shot with kite and wakeboard on Red Sea',
    gallery: [
      { src: caseStudyAsset('aqua-sports', 'gallery-1', true), alt: 'Branded watersports website hero on mobile and desktop', caption: 'Next.js site with service-specific enquiry flows' },
      { src: caseStudyAsset('aqua-sports', 'gallery-2', true), alt: 'Legacy watersports collateral before rebrand', caption: 'Inconsistent identity across print and digital' },
      { src: caseStudyAsset('aqua-sports', 'gallery-3', true), alt: 'Team delivering watersports experience on the beach', caption: 'HubSpot CRM with WhatsApp instant response' },
    ],
    beforeAfter: {
  ...
  },
  {
    ...
    accent: '#FFC107',
    bg: '#FFFBEA',
    heroImage: caseStudyAsset('desert-rose', 'hero', true),
    heroImageAlt: 'Desert Rose Hotel exterior with pool and palm garden',
    gallery: [
      { src: caseStudyAsset('desert-rose', 'gallery-1', true), alt: 'Luxury hotel pool area at golden hour', caption: 'On-site photography replacing stock imagery' },
      { src: caseStudyAsset('desert-rose', 'gallery-2', true), alt: 'Hotel room interior with neutral decor', caption: 'Before: generic room shots in feed' },
      { src: caseStudyAsset('desert-rose', 'gallery-3', true), alt: 'Minimal hotel bedroom before content refresh', caption: 'Content audit baseline' },
    ],
    beforeAfter: {
      label: 'Social content quality shift',
      before: { src: caseStudyAsset('desert-rose', 'before', true), alt: 'Plain hotel room photo used in old social posts' },
      after: { src: caseStudyAsset('desert-rose', 'after', true), alt: 'Polished resort imagery after content production' },
    },
  ...
  },
  {
    ...
    accent: '#2196F3',
    bg: '#EBF5FB',
    heroImage: caseStudyAsset('marina-view', 'hero', true),
    heroImageAlt: 'Modern marina-view residential tower at dusk',
    gallery: [
      { src: caseStudyAsset('marina-view', 'gallery-1', true), alt: 'High-rise marina residences exterior', caption: 'Launch landing page with virtual tour gate' },
      { src: caseStudyAsset('marina-view', 'gallery-2', true), alt: 'Property development site before launch campaign', caption: 'Pre-launch: construction-phase awareness' },
      { src: caseStudyAsset('marina-view', 'gallery-3', true), alt: 'Luxury apartment interior with sea view', caption: 'Show-unit photography for Meta ad creative' },
    ],
    beforeAfter: {
  ...
  },
  {
    ...
    accent: '#072A6B',
    bg: '#EEF2F9',
    heroImage: caseStudyAsset('hurghada-rentals', 'hero'),
    heroImageAlt: 'Modern furnished apartment living room in Hurghada',
    gallery: [
      { src: caseStudyAsset('hurghada-rentals', 'gallery-1'), alt: 'Dated apartment listing page before rebuild', caption: 'Legacy PHP site: 8.2s load time' },
      { src: caseStudyAsset('hurghada-rentals', 'gallery-2'), alt: 'Bright modern apartment after redesign', caption: 'Next.js rebuild with WebP image pipeline' },
      { src: caseStudyAsset('hurghada-rentals', 'gallery-3'), alt: 'Spacious rental property interior with natural light', caption: 'Structured data for 2,000+ listings' },
    ],
    beforeAfter: {
      label: 'Site performance and presentation',
      before: { src: caseStudyAsset('hurghada-rentals', 'before'), alt: 'Cluttered apartment interior representing slow legacy site' },
      after: { src: caseStudyAsset('hurghada-rentals', 'after'), alt: 'Clean modern rental listing after Next.js rebuild' },
    },
    client: 'Hurghada Rentals',
    duration: '4 months',
