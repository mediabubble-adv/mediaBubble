...
export const BLOG_AUTHORS: Record<string, InsightAuthor> = {
  yasser: {
    id: 'yasser',
    name: 'Yasser Dorgham',
    title: 'Founder & Strategy Lead',
    bio: 'Yasser founded MediaBubble in Hurghada and leads strategy for tourism, hospitality, and regional growth brands across Egypt and the Gulf.',
  ...
  omar: {
    ...
    bio: 'Omar leads technical SEO, content strategy, and multilingual site architecture for Red Sea and UAE tourism brands.',
    avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=200&h=200&q=80&crop=faces',
  },
}

export function getInsightAuthor(authorId: string): InsightAuthor {
