...
export const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    quoteFallback:  '"In six months our organic traffic grew 340%. The team understands Hurghada\'s market: who searches, how, and when."',
  ...
  },
  {
    ...
    quoteFallback:  '"Our social media engagement went from 2% to 12% in just four months. They created content that resonates with tourists visiting Hurghada."',
    authorFallback: 'Fatima Al-Rashid',
    roleFallback:   'Owner, Desert Rose Hotel',
    avatar: 'FA',
    color:  '#2196F3',
  ...
  },
  {
    ...
    quoteFallback:  '"From zero online presence to ranking #1 for \"Hurghada diving\" in under a year. MediaBubble knows how to position local businesses for growth."',
    authorFallback: 'Youssef Hamed',
    roleFallback:   'Founder, Red Sea Divers',
    avatar: 'YH',
    color:  '#1565C0',
  ...
  },
  {
    ...
    roleFallback:   'COO, Hurghada Luxury Stays',
    avatar: 'SM',
    color:  '#2196F3',
  ...
  },
  {
    ...
    roleFallback:   'CEO, Hurghada Rentals',
    avatar: 'LM',
    color:  '#072A6B',
