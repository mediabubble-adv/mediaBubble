...
export const webServiceConfig: ServicePageConfig = {
  ...
  hero: {
    ...
    imageFallback: '/assets/hero/modern/render-a.jpg',
  },
  ...
  techStack: {
    ...
    tools: [
      ...
      { name: 'Sanity / headless CMS', category: 'Optional', why: 'Structured content for multi-language tourism sites.' },
  ...
  performanceMetrics: {
    ...
    intro: 'Fast sites rank better and convert more — especially on mobile networks tourists use abroad.',
    metrics: [
      ...
      { value: '< 0.1', label: 'Cumulative layout shift', target: 'Stable hero and booking widgets on load' },
    ],
  },
  launchChecklist: {
    kicker: 'Launch',
