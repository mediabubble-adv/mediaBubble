...
const VALUES = [
  {
    ...
    descFallback:  'Every campaign starts with a specific, measurable target agreed in writing before we spend a pound. If we are off-track at week six, you hear it from us first, not from a dashboard.',
  },
  {
    icon:  Users,
    color: '#072A6B',
      ...
      <Container>
        <div data-reveal className="max-w-2xl mb-12 sm:mb-16 lg:mb-20">
          ...
          <p className="text-[16px] text-brand-secondary dark:text-brand-text-muted leading-relaxed">
            {t('about.values.subtitle', "We've refined our approach over ten years of working with businesses in Hurghada and across Egypt. These three principles drive every decision we make.")}
          </p>
        </div>
