...
import { getAgent, getSkills } from '@/lib/utils/enrich-node'
import { fuzzyMatchAny } from '@/lib/utils/fuzzy-search'
    ...
    <div className="select-none">
      <div className={`flex items-start gap-1 rounded-lg transition-all duration-150 ${
        ...
        <div className="flex-1 min-w-0">
          <button
            ...
            className={`
              flex items-center gap-2 w-full text-start rounded-lg transition-all duration-150
              ${depth === 0
          ...
          >
            ...
            {agentInfo && isLeaf && (
              ...
              >
                <User size={9} className="inline me-0.5 -mt-0.5" />
                {agentInfo.agent}
              </span>
            )}
          ...
          {isLeaf && skills.length > 0 && (
            <Collapsible expanded={detailOpen}>
              <div className="ps-7 pe-3 pb-2 pt-1 space-y-1">
                {skills.map((skill, i) => (
        ...
        <div className="flex items-start gap-0.5 pt-1 pe-1 shrink-0">
          {isLeaf && skills.length > 0 && (
            <button
      ...
      {hasChildren && (
        <Collapsible expanded={expanded}>
          <div className={`ms-${depth === 0 ? '2' : '3'} border-s border-gray-100 ps-1`}>
