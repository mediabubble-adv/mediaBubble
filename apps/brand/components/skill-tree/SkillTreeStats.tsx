...
import { taxonomyTree, branchColors, countLeaves, getLeafIds, getAllBranchLeafCounts } from '@/lib/data/arabic-taxonomy'
            ...
            <div key={b.id} className="animate-fade-in-up-stagger" style={{ animationDelay: `${i * 0.03}s` }}>
              <div className="flex items-center justify-between text-[11px] mb-1">
                ...
                <span className="text-gray-400 tabular-nums">
                  {b.completed}/{b.total}
                  <span className="ms-1.5 font-medium" style={{ color: b.percent >= 50 ? '#16a34a' : b.percent > 0 ? '#ea580c' : '#9ca3af' }}>
                    {b.percent}%
                  </span>
                </span>
              </div>
