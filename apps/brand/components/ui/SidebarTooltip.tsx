    ...
    >
      ...
      {visible && coords && (
        <span
          ...
          className="pointer-events-none z-[9999] whitespace-nowrap rounded-md border border-white/[0.06] bg-[#0D0F12] px-2.5 py-1.5 text-[11px] font-medium text-white shadow-[0_6px_20px_rgba(0,0,0,0.4)]"
        >
          {label}
        </span>
      )}
