...
import { channelListWhere, uniqueMemberIds, canCreateChannelType } from '@/lib/comms/access'
...
export async function POST(req: Request): Promise<Response> {
  ...
  if (!canCreateChannelType(type, me.role)) {
    return toResponse(fail('forbidden', 'Manager access required to create channels', 403))
  }
