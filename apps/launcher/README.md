...
Scope and progress: [`LAUNCHER_PLAN_V2.md`](../../docs/launcher/LAUNCHER_PLAN_V2.md).
...
- **Schema reference:** [`LAUNCHER_DATABASE_SCHEMA.sql`](../../docs/launcher/LAUNCHER_DATABASE_SCHEMA.sql)
...
| Document                                                                             | Purpose                               |
| ------------------------------------------------------------------------------------ | ------------------------------------- |
| [`LAUNCHER_PLAN_V2.md`](../../docs/launcher/LAUNCHER_PLAN_V2.md)                     | Phase scope and progress              |
| [`LAUNCHER_DATABASE_SCHEMA.sql`](../../docs/launcher/LAUNCHER_DATABASE_SCHEMA.sql)   | Canonical SQL schema                  |
| [`LAUNCHER_TECHNICAL_ROADMAP.md`](../../docs/launcher/LAUNCHER_TECHNICAL_ROADMAP.md) | Full 8-app vision                     |
