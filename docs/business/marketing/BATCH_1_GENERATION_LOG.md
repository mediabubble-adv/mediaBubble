...
**Batch Focus**: 7 base hero images (4 Main Hero variations + 3 Services Discovery variations)
**Target Resolution**: 4K (4096x2304) for heroes
**Magnific Settings**: Creativity 75/100, Mode Creative
**Timeline**: ~2.5 hours (parallel processing)
...
4. **Main Hero v4** — High depth, layered planes, white highlights dominant
...
- ✓ File size reasonable (~3-5MB WebP)
...
- ✓ No visual noise or complexity
- ✓ White spacers visible and breathing
- ✓ Professional lighting (completely soft)
...
2. Create folder structure:
   ...
   /Assets/
     ...
     │  │  ├─ MainHero_v4.webp (4K)
     │  ├─ /ServicesDiscovery/
     │  │  ├─ ServicesDiscovery_v1.webp (3K)
     │  │  ├─ ServicesDiscovery_v2.webp (3K)
     │  │  ├─ ServicesDiscovery_v3.webp (3K)
   ```
3. Save to workspace folder for backup

---

## SUCCESS CRITERIA FOR BATCH 1

✅ **All 7 images generated** (4 Main Hero + 3 Services Discovery)
✅ **Color accuracy verified** — All brand colors (#FFDE11, #358DCC, #50C4DD, #005282) match hex values
✅ **Composition approved** — Network hub and geometric layers readable and balanced
✅ **Professional quality** — No artifacts, clean lighting, polished appearance
✅ **Web optimized** — WebP format, ~2-5MB per image
✅ **Director approval** — Visuals establish clear brand direction for remaining tiers
...
1. **Magnific Settings Matter**:
   - Main Hero: 4K, Creativity 75/100 (hero-grade quality)
   - Services Discovery: 3K, Creativity 70/100 (clean, minimal)

2. **Color Accuracy is Non-Negotiable**:
   - Always specify hex values in prompts
   - Check first output for color drift
   - If colors are off, regenerate immediately

3. **Parallel Processing**:
   - Submit all 4 Main Hero variations at once
   - Magnific handles parallel processing efficiently
   - Don't wait for v1 to finish before submitting v2-v4

4. **Quality Over Quantity**:
   - 99% of outputs should be production-ready
   - Regenerate only obvious failures (~1 per batch)
   - Don't overthink minor variations
