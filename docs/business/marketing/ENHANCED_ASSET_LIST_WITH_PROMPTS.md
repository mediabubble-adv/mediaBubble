...
- **Aesthetic**: Tech-forward agency, global connectivity, network-driven

---

## TIER 1: HERO & PRIMARY HERO SECTIONS (Priority: Critical)
...
- Color Integration: Base colors soft (50% opacity), accent with yellow nodes/highlights
- Mood: Aspirational, trustworthy, forward-thinking
...
**Assets Generated**: 4 variations (different color treatments, node densities)
**Magnific Upscale**: 2x to 4K (3840x2160)
**Outpaint Variants**: 9:16 (mobile) + 21:9 (ultra-wide)
**Total Output**: 1 base + 4 variations + 3 responsive variants = 8 hero images
...
- Mood: Inviting, exploratory, organized
...
No icons, no text, no people. Abstract geometric, minimal, modern.
Aspect ratio: 16:9. Clean, trustworthy, inviting mood."
```

**Assets Generated**: 3 variations
**Magnific Upscale**: 2x to 4K
**Total Output**: 3 + 2 responsive = 5 images

---

## TIER 2: SERVICE CATEGORY VISUALS (Priority: High)
...
Modern, abstract, no human faces, no logos, no text.
16:9 aspect ratio."
```

**Assets Generated**: 2 variations
**Magnific Upscale**: 2x
**Total Output**: 2 + 1 responsive = 3 images
...
Composition: Symmetrical with subtle asymmetric accents.
Abstract, modern, no text, no logos, no people.
Mood: Creative, professional, trustworthy, premium.
16:9 aspect ratio."
```
...
Modern, abstract, no text, no logos, no people.
Mood: Engaging, dynamic, story-focused.
16:9 aspect ratio."
```
...
Color palette: professional blue (#358DCC) frames, yellow (#FFDE11) motion elements,
dark background (#005282), cyan accents.
Lighting: Cinematic, slightly dramatic, high contrast.
Composition: Layered frames creating depth, motion vectors suggest action.
Modern, professional, no text, no logos, no people.
Mood: Creative, dynamic, production-quality.
16:9 aspect ratio."
```
...
blue (#358DCC) for network nodes, cyan (#50C4DD) connection lines,
dark background (#005282).
Lighting: Energetic, glowing nodes with subtle glow effect.
Composition: Radial expansion from center suggesting growth and amplification.
Modern, abstract, no text, no logos, no people.
Mood: Social, connected, growing, energetic.
16:9 aspect ratio."
```
...
bright yellow (#FFDE11) highlighting key insights/peaks,
dark navy background (#005282), cyan accent lines.
Lighting: Clean, professional, high clarity.
Composition: Organized dashboard-like layout with visual hierarchy.
Modern, professional, no text, no logos, no people.
Mood: Insightful, professional, data-driven, clear.
16:9 aspect ratio."
```
...
## TIER 3: FEATURE CARDS & SECTION VISUALS (Priority: Medium-High)
...
[For Step 3]: Execution/Launch - action-oriented elements, all colors integrated.
[For Step 4]: Analysis - dashboard/graph focus, data-visualization theme.
[For Step 5]: Optimization - upward trajectory, yellow highlighting improvement.

For each: minimal geometric shapes, clean lines, professional diagram style.
Color palette: step colors (yellow #FFDE11, blue #358DCC, cyan #50C4DD).
Lighting: Clean, flat, no shadows.
No text, no logos, no people. Diagram-quality professional.
Square aspect ratio (1:1). Clear step progression."
```

**Assets Generated**: 5 (one per step) + 2 variations per step = 15 total
**Magnific Upscale**: 2x (square format)
**Total Output**: 15 images
...
Lighting: Soft, even, no contrast.
Composition: Repeating minimal pattern across full canvas.
Professional, trustworthy, subtle. No text, no logos, no people.
Background texture quality. 1600x900 aspect ratio."
```

**Assets Generated**: 1 main pattern + 2 color variations
**Magnific Upscale**: 2x
**Total Output**: 3 repeatable patterns
...
Modern, professional, results-focused. No text, no logos, no people.
16:9 aspect ratio. Success and achievement mood."
```
...
## TIER 4: SECONDARY ASSETS (Priority: Medium)
...
Composition: Symmetrical with transformation element in center.
Modern, professional, success-focused. No text, no logos, no people.
16:9 aspect ratio. Premium case study mood."
```

**Assets Generated**: 4 variations (different transformation concepts)
**Magnific Upscale**: 2x
**Total Output**: 4 + 2 responsive = 6 images
...
[Article Type 1 - Strategy]: Strategic thinking metaphor,
planning board aesthetic, organized composition.

[Article Type 2 - Trends]: Forward-looking, trend arrow concept,
dynamic, flowing composition.

[Article Type 3 - How-To]: Process/steps concept,
building blocks or layer visualization.

For each: Abstract, modern, professional.
Color palette: brand colors (yellow, blue, cyan, navy).
Lighting: Clean, professional, high clarity.
Composition: Balanced, 50% text-overlay friendly (design for opacity).
No text, no logos, no people. Educational, trustworthy mood.
16:9 aspect ratio."
```
...
Color palette: bright yellow (#FFDE11) as action highlight,
blue (#358DCC) as primary, cyan accents, dark background.
Lighting: Energetic, slightly dramatic, high contrast to stand out.
Composition: Asymmetric, directional, action-focused.
Modern, energetic, compelling. No text, no logos, no people.
16:9 aspect ratio. High-energy conversion mood."
```

**Assets Generated**: 2 variations (left-pointing, right-pointing)
**Magnific Upscale**: 2x
**Total Output**: 2 + 1 responsive = 3 images

---

## TIER 5: SOCIAL & PROMOTIONAL (Priority: Lower)
...
**Assets Generated**: 3 (one per platform)
**Magnific Upscale**: 2x (if possible; some may need redesign for platform)
**Total Output**: 3 images
...
Color palette: Professional blue (#358DCC) and yellow (#FFDE11),
with strong contrast to dark/light backgrounds.
Lighting: High clarity, no soft shadows.
Composition: Balanced, minimal, email-safe.
Modern, professional, newsletter-appropriate. 600x200 aspect ratio.
No text, no logos, no people. Email-safe mood."
```

**Assets Generated**: 1 with light + dark versions
**Magnific Upscale**: 2x
**Total Output**: 2 variations

---

## TIER 6: RESPONSIVE VARIANTS (Auto-Generated from Tiers 1-5)
...
4. Review for consistency, regenerate if needed

**Total Responsive Variants**: ~35-40 images from base 15-20 hero concepts
...
Tier 3 (Features): 15 process + 3 testimonial + 3 metrics = 21 images
Tier 4 (Case Studies): 6 + 5 blog + 3 CTA = 14 images
Tier 5 (Social): 3 + 2 email = 5 images
Tier 6 (Responsive): ~35 outpainted variants = 35 images

TOTAL BASE GENERATION: 74 unique images
TOTAL WITH RESPONSIVE: 109 optimized web-ready assets
```
...
Day 3: Tier 5 + QC (5 images) → 45 min
Day 4: Magnific upscale all 74 images → 30 min
Day 5: Outpaint 15-20 hero images to 3 ratios → 60 min
Days 6-7: Design frontend, integrate assets, animations → 8-10 hours

TOTAL: 7 days (with parallel generation where possible)
```

---

## MAGNIFIC UPSCALE STRATEGY FOR THIS ASSET SET

**Recommended Approach**:

1. **Batch 1**: Tiers 1-2 (29 images) → Magnific 2x → Process all in parallel
2. **Batch 2**: Tiers 3-4 (35 images) → Magnific 2x → Process 10 at a time
3. **Batch 3**: Tier 5 (5 images) → Magnific 2x → Quick batch
4. **Quality Review**: Check each upscaled image for artifacts, color drift
5. **Reject & Regenerate**: If >5% artifacts, regenerate base image, re-upscale
...
4. **Always reference**: "Modern," "professional," "premium," "trustworthy"
5. **Always specify**: Lighting (studio, clean, professional, dramatic, soft)
...
4. Regenerate 2-3 variations, pick best, upscale that one

---

## NEXT STEPS

1. ✅ **Approved Prompts List**: All 30+ prompts above are ready
2. **Batch Generation Priority**: Start with Tier 1 (4 hero variations)
3. **Test Magnific Workflow**: Generate 1 hero → Magnific 2x → Outpaint 9:16 & 21:9
4. **Review Cycle**: Show client 3-4 hero options before generating full set
5. **Design Integration**: Build homepage while batches process in background

---

**Status**: Asset list finalized and ready for generation.
**Next Action**: Begin Tier 1 hero generation (4 concepts).
