...
**Tools You'll Use**: Free AI image generator + Magnific MCP (for upscaling)
...
1. Right-click each generated image → **Download**
2. Save to folder:
   ```
   /Users/Dorgham/Documents/Work/Development/mediiabubble Main/Generated Assets/Batch1/MainHero/
   ```
3. Rename files:
   - `MainHero_v1.png`
   - `MainHero_v2.png`
...
## STEP 3: Upscale with Magnific MCP (We Handle This)

Once you return with the 4 image files:

1. **We upload each image** via MCP
2. **Apply Magnific 4x upscale** for production-ready 4K
3. **Convert to WebP** for web optimization
4. **Output**: 4 × 4K images, 2-4MB each, ready for use

**This part takes: 5 minutes (automated)**
...
✅ **Recraft/Ideogram are free** — No account upgrades needed
✅ **You control quality** — See images in real-time, regenerate if needed
✅ **Magnific MCP is ready** — We'll handle professional upscaling
✅ **Faster overall** — 3-5 min generation + 5 min upscaling = 10 min total
✅ **Production-ready** — 4K assets perfect for web deployment

---

## PROMPTS AT A GLANCE

Copy these into Recraft/Ideogram:

**V1 (Yellow Dominant):**
Dense network, high node density, yellow focus, deep blue background, professional CGI.

**V2 (Blue Dominant):**
Sparse elegant network, clean lines, blue dominant, subtle yellow highlights, sophisticated.

**V3 (Balanced Colors):**
Mixed density network, balanced yellow/cyan/blue, white highlights for clarity, complex layering.

**V4 (White Highlights):**
High depth, multi-layered planes, white rim lighting, dramatic studio lighting, sophisticated depth.
