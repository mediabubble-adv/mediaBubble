# SKILL DEFINITIONS: Arabic Language Skills (5 Skills)

---

## SKILL #1: arabic:language-masri-core

**Name:** Arabic: Masri (Egyptian) Core  
**Slug:** arabic:language-masri-core  
**Parent:** arabic:language  
**Level:** Beginner → Intermediate  
**Focus:** Colloquial Egyptian Arabic for everyday conversation
...
- Emotions & feelings
- Colloquial pronunciation (vowel dropping, emphasis patterns)
...
- Learning platforms: Preply, iTalki, Duolingo Masri track
...
- Reference authentic Egyptian media
- Note Cairo vs. Upper Egypt pronunciation differences
- Provide English equivalents for non-Masri speakers

**Example Trigger:**
"Teach me how to greet people in Egyptian Arabic"  
→ Provides Masri greetings with pronunciation, formality levels, and cultural context

---

## SKILL #2: arabic:language-masri-business

**Name:** Arabic: Masri (Egyptian) Business & Professional  
**Slug:** arabic:language-masri-business  
**Parent:** arabic:language  
**Level:** Intermediate → Advanced  
**Focus:** Professional Egyptian Arabic for business contexts
...
- Workplace relationships & hierarchy
...
- 15+ professional Egyptian media resources
...
- Reference real Egyptian business examples
- Provide MSA equivalents for very formal contexts
- Note code-switching patterns (Masri + MSA blend)

**Example Trigger:**
"How do I write a professional email in Egyptian Arabic?"  
→ Provides templates, formality markers, cultural context

---

## SKILL #3: arabic:language-msa-formal

**Name:** Arabic: Modern Standard Arabic (MSA) Formal  
**Slug:** arabic:language-msa-formal  
**Parent:** arabic:language  
**Level:** Intermediate → Advanced  
**Focus:** Formal Modern Standard Arabic for academic/media contexts
...
- News & media language
- Official documents & legal Arabic
...
- 20+ media resources (Al Jazeera, news outlets)
...
- Note MSA's limited use in casual conversation
- Clarify MSA vs. Masri code-switching rules
- Provide context on when Masri speakers shift to MSA

**Example Trigger:**
"How do I write a formal letter in Arabic?"  
→ Provides MSA structure, formal phrases, example letters

---

## SKILL #4: arabic:language-regional-dialects

**Name:** Arabic: Regional Dialects Beyond Masri  
**Slug:** arabic:language-regional-dialects  
**Parent:** arabic:language  
**Level:** Intermediate → Advanced  
**Focus:** Levantine, Gulf, Moroccan, Sudanese Arabic varieties
...
- Sudanese Arabic features
- Phonetic variations by region
- Vocabulary differences & cognates
...
- Cultural context & regional pride
...
- Respect regional identity & pride
- Explain when to use/not use specific dialects
- Provide cultural context for each region

**Example Trigger:**
"What's the difference between Egyptian and Levantine Arabic?"  
→ Compares pronunciation, vocabulary, cultural context

---

## SKILL #5: arabic:language-translation

**Name:** Arabic: Translation & Localization  
**Slug:** arabic:language-translation  
**Parent:** arabic:language  
**Level:** Advanced  
**Focus:** English ↔ Arabic translation techniques & terminology
...
- Common translation errors & fixes
...
- 10+ professional translation platforms
...
- Reference professional translation standards
- Explain cost/quality/speed tradeoffs for AI translation

**Example Trigger:**
"How do I translate this marketing campaign into Arabic?"  
→ Provides localization strategy, terminology, cultural considerations
...
- Follow agent behavior guidelines in automated responses
- Include pronunciation guides & cultural context consistently
- Reference authentic media throughout
...
4. Regional Dialects (extensions)
5. Translation (applied skill)

This progression supports learners at any starting point.
