# MediaBubble Brand Guidelines

**Version:** 1.0  
**Date:** June 2026  
**Company:** MediaBubble — Marketing & Advertising Agency  
...
5. [Usage Examples & Do's/Don'ts](#usage-examples--dondts)
...
2. **Marketing & Digital Growth** — SEO, SEM, social media advertising and management, email marketing, lead generation, content strategy
3. **Branding & Design** — Logo design, brand development, print collateral, corporate events
...
- **End-to-end capability:** One partner for strategy, creative, production, and execution
...
- Client-facing pitches and proposals
...
- Solution-oriented and benefits-led
...
- Includes clear calls-to-action at natural stopping points
...
- Never rotate, alter colors, or add effects to the logo
- Use the full lockup when space allows; use the icon/mark only when necessary
- On dark backgrounds: Use white logo
- On light backgrounds: Use full-color logo
- On brand-colored backgrounds: Use white or black logo for contrast

**Asset Location:** `/branding/01-Logo/` (all formats stored on Google Drive)
...
- **RGB:** 33, 150, 243
- **CMYK:** 87, 38, 0, 5
- **Usage:** Secondary buttons, links, navigation accents, supporting elements
...
- Apply the same spacing and font-size scale across the site
...
- **Micro spacing:** 4px (between text and icon, tight grouping)
- **Small spacing:** 8px (padding within components, tight sections)
- **Medium spacing:** 16px (padding between components, sections)
- **Large spacing:** 24px (section margins, major breaks)
- **Extra-large spacing:** 32px+ (page-level sections, hero to content)

**Consistency Rule:** All padding, margins, and spacing should be multiples of 8px to maintain visual harmony across the site.
...
- "Partner with us" (not "hire us," "work with us," "choose us")
...
- Content Strategy (not "content planning," "content services")
- Brand Development (not "branding," "brand strategy")
...
- "Let's Talk Strategy"
- More conversational, first-person, benefit-led

### Prohibited Phrases

- ❌ "Full-service solutions"
- ❌ "Award-winning team" (we have awards, but this is overused)
- ❌ "Next-gen technology" (without specifics)
- ❌ "Contact us today" (use "Schedule a Free Consultation")
- ❌ "Click here" (use descriptive CTA text)
- ❌ "Learn more" as the primary CTA (be specific)
- ❌ "State-of-the-art" / "Cutting-edge" (without proof)
...
- Bottom-of-funnel content (reviews, comparisons, how-to guides)
...
📁 07-Marketing
  📁 01-Branding
    📁 Logo
      📄 MediaBubble_Logo_Horizontal_Full-Color.svg
      📄 MediaBubble_Logo_Horizontal_Black.svg
      📄 MediaBubble_Logo_Vertical_Full-Color.svg
      📄 MediaBubble_Logo_Mark_Icon.svg
    ...
    📁 Font
      ...
      📄 Inter-SemiBold.ttf
    📁 Color-Palette
      📄 MediaBubble_Colors.pdf
      📄 mediaBubble_guidelines.ai [AUTHORITATIVE SOURCE]
    📁 Templates
      📄 Email_Template.html
      📄 Social_Media_Template.psd
      📄 Presentation_Template.pptx
  📁 03-MB Website
    📄 Media Bubble - Website [live website copy and strategy]
    📄 Mediabubble - Website Criteria.pptx [design audit and decisions]
  📁 04-Blog & Content
    📄 mediabubble | Blog Posts [published blog content examples]
    📄 MB Social Media Main Streams [content taxonomy and strategy]
```
...
2. If not found, submit a request to the design/branding team with:
   ...
   - Where it will be used (e.g., "LinkedIn organic posts, weekly cadence")
   - Any specific color/font preferences
   - Timeline
...
2. **Confirm logo system is current** (2021 logo set vs. any newer versions)
   - Verify live website (mediabubble.co) uses the 2021 logo system
   - If newer logo exists, update this guideline with the latest

3. **Validate CTA color rules** with the design/marketing lead
   - Confirm yellow = primary CTA, blue = secondary (per 2025 website audit)
...
These guidelines reflect MediaBubble's existing brand voice, positioning, and visual identity as discovered across company documents, website content, and internal materials. They are living documents—if you discover gaps, conflicts, or need clarifications, please flag them for the team.

**Next scheduled review:** Q4 2026

**Contact:** Design & Marketing Team (imahmoud.mediabuble@gmail.com, shimaa.mediabubble@gmail.com)
