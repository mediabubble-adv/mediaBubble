...
var tailwindPreset = require('./tailwind-preset.cjs.js');
...
function FeatureCard({
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("div", {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(lucideReact.CheckCircle2, {
      size: 20,
...
function TestimonialCard({
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("div", {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx("div", {
      ...
      children: Array.from({
        length: 5
      }).map((_, i) => /*#__PURE__*/jsxRuntime.jsx("svg", {
        width: "14",
        height: "14",
        viewBox: "0 0 14 14",
        fill: "#FFC107",
    ...
    }), /*#__PURE__*/jsxRuntime.jsxs("blockquote", {
      children: [/*#__PURE__*/jsxRuntime.jsxs("p", {
        ...
        children: [avatarUrl ? /*#__PURE__*/jsxRuntime.jsx("img", {
          src: avatarUrl,
          alt: author,
          ...
          children: [/*#__PURE__*/jsxRuntime.jsx("p", {
            ...
            children: author
          }), (title || company) && /*#__PURE__*/jsxRuntime.jsx("p", {
...
function CaseStudyCard({
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(Tag, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx("div", {
      ...
      children: description
    }), href && /*#__PURE__*/jsxRuntime.jsxs("div", {
      ...
      children: ["View Case Study", /*#__PURE__*/jsxRuntime.jsx("svg", {
        width: "14",
        height: "14",
        viewBox: "0 0 14 14",
        fill: "none",
...
function Input(_a) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("div", {
    ...
    children: [label && /*#__PURE__*/jsxRuntime.jsx("label", {
      ...
      role: "alert",
      children: error
    }), !error && hint && /*#__PURE__*/jsxRuntime.jsx("p", {
      id: `${inputId}-hint`,
...
function MasterSwatch({
  ...
  return /*#__PURE__*/jsxRuntime.jsx("div", {
    className: "bg-brand-surface rounded-xl border border-brand-whisper-border dark:border-brand-light-border shadow-[0_2px_6px_rgba(0,0,0,0.07)] dark:shadow-black/20 overflow-hidden mb-8",
    children: /*#__PURE__*/jsxRuntime.jsxs("div", {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx("div", {
        ...
        children: copiedId === 'master-color' ? /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
          children: [/*#__PURE__*/jsxRuntime.jsx(lucideReact.Check, {
            size: 13,
            className: "text-green-400 animate-pulse-once"
          }), " Copied"]
        }) : /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
          children: [/*#__PURE__*/jsxRuntime.jsx(lucideReact.Copy, {
            size: 13
          }), " Copy"]
        })
      })]
...
function SectionHeader({
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("div", {
    ...
    children: [kicker && /*#__PURE__*/jsxRuntime.jsx("p", {
      ...
      children: title
    }), intro && /*#__PURE__*/jsxRuntime.jsx("p", {
...
function TimelineSection({
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("section", {
    className: className,
    "aria-label": ariaLabel,
    children: [showHeader ? /*#__PURE__*/jsxRuntime.jsx(SectionHeader, {
      kicker: kicker,
      title: title !== null && title !== void 0 ? title : '',
      intro: intro,
      light: light,
      className: "mb-12"
    }) : null, variant === 'vertical' ? /*#__PURE__*/jsxRuntime.jsx("ol", {
      className: "relative space-y-8 border-s border-brand-whisper-border dark:border-white/10 ps-6 list-none m-0 p-0",
      children: steps.map((step, index) => /*#__PURE__*/jsxRuntime.jsxs("li", {
        className: "relative",
        children: [/*#__PURE__*/jsxRuntime.jsx("span", {
          ...
          children: step.title
        }), step.description ? /*#__PURE__*/jsxRuntime.jsx("p", {
      ...
      children: steps.map((step, index) => /*#__PURE__*/jsxRuntime.jsxs("li", {
        className: "relative",
        children: [index < steps.length - 1 ? /*#__PURE__*/jsxRuntime.jsx("div", {
...
function FaqAccordion({
  ...
  return /*#__PURE__*/jsxRuntime.jsx("div", {
    ...
    role: "region",
    "aria-label": ariaLabel,
    children: items.map((faq, index) => /*#__PURE__*/jsxRuntime.jsxs("details", {
      className: "group py-5 first:pt-0 last:pb-0",
      children: [/*#__PURE__*/jsxRuntime.jsxs("summary", {
...
function CellValue({
  ...
  if (typeof value === 'boolean') {
    return value ? /*#__PURE__*/jsxRuntime.jsx(lucideReact.Check, {
      size: 18,
      className: "text-brand-success mx-auto",
      "aria-label": "Included"
    }) : /*#__PURE__*/jsxRuntime.jsx(lucideReact.Minus, {
      size: 18,
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx("thead", {
        children: /*#__PURE__*/jsxRuntime.jsxs("tr", {
          children: [/*#__PURE__*/jsxRuntime.jsx("th", {
            ...
            children: "Feature"
          }), columns.map((column, index) => /*#__PURE__*/jsxRuntime.jsx("th", {
            scope: "col",
        ...
        children: rows.map(row => /*#__PURE__*/jsxRuntime.jsxs("tr", {
          ...
          children: [/*#__PURE__*/jsxRuntime.jsx("th", {
            ...
            children: row.label
          }), row.values.map((value, index) => /*#__PURE__*/jsxRuntime.jsx("td", {
...
function TabbedShowcase({
  ...
  var _a, _b, _c;
  const [activeId, setActiveId] = React.useState((_b = defaultTabId !== null && defaultTabId !== void 0 ? defaultTabId : (_a = tabs[0]) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : '');
  if (tabs.length === 0) {
    return null;
  }
...
function usePrefersReducedMotion() {
  const [prefersReducedMotion, setPrefersReducedMotion] = React__namespace.useState(false);
  ...
  return /*#__PURE__*/jsxRuntime.jsx("div", {
    ...
    children: /*#__PURE__*/jsxRuntime.jsx("div", {
      ...
      children: duplicated.map((item, index) => {
        const img = /*#__PURE__*/jsxRuntime.jsx("img", {
          src: item.src,
          alt: item.alt,
        ...
        return item.href ? /*#__PURE__*/jsxRuntime.jsx("a", {
          href: item.href,
          className: "shrink-0",
          children: img
        }, `${item.alt}-${index}`) : /*#__PURE__*/jsxRuntime.jsx("span", {
          className: "shrink-0",
          children: img
        }, `${item.alt}-${index}`);
      })
...
exports.mbPreset = tailwindPreset.default;
exports.mbTailwindPreset = tailwindPreset.default;
exports.Badge = Badge;
exports.BentoGrid = BentoGrid;
exports.BentoItem = BentoItem;
...
exports.Input = Input;
exports.LogoMarquee = LogoMarquee;
exports.MasterSwatch = MasterSwatch;
exports.MetricStrip = MetricStrip;
exports.SectionHeader = SectionHeader;
exports.ServiceCard = ServiceCard;
exports.TabbedShowcase = TabbedShowcase;
